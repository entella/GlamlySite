        ...
        public string ResponseMessage
        {
            get
            {
                if (ResponseCode == Codes.InternalServerError)
                    ...
                    return "User delete successfully." + ((!string.IsNullOrWhiteSpace(_message)) ? (" " + _message) : string.Empty);
                else if (ResponseCode == Codes.FailedDeleteStylist)
                    return "Stylist unable to delete due to having booking." + ((!string.IsNullOrWhiteSpace(_message)) ? (" " + _message) : string.Empty);
                else
