...
namespace GlamlyData
{
    ...
    public partial class GlamlyEntities : DbContext
    {
        ...
        public virtual DbSet<wp_glamly_Calendar> wp_glamly_Calendar { get; set; }
        public virtual DbSet<wp_glamly_servicesbookings> wp_glamly_servicesbookings { get; set; }
        public virtual DbSet<wp_glamly_stylistTemp> wp_glamly_stylistTemp { get; set; }
        public virtual DbSet<wp_glamly_faq> wp_glamly_faq { get; set; }
